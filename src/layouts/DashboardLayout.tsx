  ...
  const webControlMenuItems = [
    {
      title: "Profil Desa",
      items: [
        { title: "Profil Desa", path: "/dashboard/profil-desa", icon: Home },
          ...
          <Sidebar className="bg-black shadow-sm">
            ...
            <SidebarContent>
              <div className="space-y-1 px-2 py-4">
                ...
                <Link href="/dashboard/tata-ruang" className="flex items-center gap-2 px-3 py-2 text-sm rounded-md hover:bg-emerald-100/10 transition-colors text-white">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="settings" className="border-none">
                    ...
                    <AccordionContent>
                      <div className="space-y-1 pl-4">
                        <Link href="/dashboard/pengaturan" className="flex items-center gap-2 px-3 py-2 text-sm rounded-md hover:bg-emerald-100/10 transition-colors text-white">
            ...
            <SidebarFooter className="p-4">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem>
                    <Link href="/dashboard/pengaturan" className="flex items-center">
