              ...
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Informasi dasar pendapatan desa tahun {pendapatanData.umum.content.tahun}
                  </p>
                </div>
              </CardHeader>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Program pendapatan desa tahun {pendapatanData.umum.content.tahun}
                  </p>
                </div>
              </CardHeader>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Realisasi pendapatan desa dari tahun ke tahun
                  </p>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
