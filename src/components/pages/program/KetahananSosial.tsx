              ...
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Informasi dasar ketahanan sosial desa tahun {sosialData.umum.content.tahun}
                  </p>
                </div>
              </CardHeader>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Program penguatan sosial desa tahun {sosialData.umum.content.tahun}
                  </p>
                </div>
              </CardHeader>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pencapaian ketahanan sosial desa dari tahun ke tahun
                  </p>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
